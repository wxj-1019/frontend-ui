...
import { ScrollReveal as GsapScrollReveal } from "@frontend-ui/ui";
...
export default function ScrollRevealPage() {
  return (
    <ComponentDocPage
      ...
      name="ScrollReveal"
      description="基于 GSAP ScrollTrigger 的滚动触发动画，支持多方向、scrub、pin 等高级功能"
      installName="scroll-reveal"
      importStatement={'import { ScrollReveal } from "@frontend-ui/ui";'}
      defaultValues={{ direction: "up", delay: 0, distance: 60 }}
      propConfig={[
        {
          name: "direction",
          type: "string",
        ...
        { name: "delay", type: "number", min: 0, max: 2, step: 0.1 },
      ...
      propDocs={[
        ...
        { name: "className", type: "string", default: "-", description: "自类名" },
      ]}
