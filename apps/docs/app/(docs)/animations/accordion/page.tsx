      ...
      propDocs={[
        {
          ...
          required: true,
          description:
            '面板项数组，每项包含 title (string) 和 content (ReactNode)',
        },
        {
          name: 'className',
          type: 'string',
        ...
        },
        {
          ...
          type: 'number',
          default: '-',
          description: '默认展开项索引，不传则全部折叠',
        },
        {
          name: 'allowMultiple',
          type: 'boolean',
          default: 'false',
          description: '是否允许同时展开多项',
        },
        {
          name: 'duration',
          type: 'number',
              ...
              <Accordion
                ...
                items={[
                  ...
                  },
                  {
                    title: '如何开始？',
                    content: (
                      <p className="text-sm">安装依赖后即可开始使用。</p>
                    ),
                  },
                ]}
              />
                ...
                items={[
                  {
                    title: '功能一',
                    content: (
                      <p className="text-sm">支持自定义动画时长和展开模式。</p>
                    ),
                  },
                  {
                    title: '功能二',
                  ...
                  },
                  {
                    title: '功能三',
                    content: (
                      <p className="text-sm">完整的无障碍支持和键盘导航。</p>
                    ),
                  },
                ]}
              />
                ...
                items={[
                  {
                    ...
                    content: (
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-sm">
                          前端 UI
                          库是一套可复用的组件集合，帮助开发者快速构建一致的用户界面，减少重复开发工作。
                        </p>
                      </div>
                    ),
                  },
                  {
                    ...
                    content: (
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-sm">
                          通过 CSS
                          变量覆盖默认主题色值，支持亮色和暗色模式切换，也可通过配置文件自定义全局样式。
                        </p>
                      </div>
                    ),
                  },
