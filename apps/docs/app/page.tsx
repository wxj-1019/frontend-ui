...
import { BlurText, SpotlightCard, ScrollReveal, Parallax } from "@frontend-ui/ui";
    ...
    <div className="min-h-screen bg-[var(--color-bg-primary)]">
      ...
      <section className="relative overflow-hidden pt-32 pb-24">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <Parallax speed={-0.15}><div className="absolute -top-40 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-[var(--color-accent)]/15 blur-[150px] animate-pulse" /></Parallax>
          <Parallax speed={0.1}><div className="absolute top-20 right-1/4 h-64 w-64 rounded-full bg-[var(--color-accent)]/10 blur-[120px] animate-pulse delay-1000" /></Parallax>
          <Parallax speed={-0.08}><div className="absolute top-40 left-1/4 h-48 w-48 rounded-full bg-[var(--color-accent)]/10 blur-[100px] animate-pulse delay-500" /></Parallax>
        </div>
        ...
        <HeroTimeline className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="hero-item mx-auto mt-6 max-w-2xl text-lg text-[var(--color-text-muted)]">
            企业级前端动画组件库，集成 GSAP、Motion、react-spring 等 6+ 动画引擎，
